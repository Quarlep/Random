...
M_craft = random.randint(6000, 9000) # mass of the rocket in kg
Fuel = random.randint(5000, 9000) # mass of the fuel in kg
H = random.randint(150000, 250000)   # initial height in meter
V = random.randint(1300, 2500)  # initial velocity in m/s
